    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
                ...
                @php
                    $hasPhoto = !empty($parent->photo);
                    $previewSrc = $hasPhoto ? asset('storage/' . $parent->photo) : 'https://ui-avatars.com/api/?name=Parent&background=random';
                @endphp

                <form action="{{ route('school-management.parents.update', $parent) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="md:col-span-2">
                                    ...
                                    <textarea name="address"
                                              ...
                                              class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">{{ old('address', $parent->address) }}</textarea>
                                    @error('address')
                                        <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text"
                                           name="country"
                                           id="country"
                                           value="{{ old('country', $parent->country) }}"
