                ...
                <div class="flex items-center justify-between">
                    <div>
                        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                            {{ __('Bulk Upload Parents/Guardians') }}
                        </h2>
                ...
                <div class="mb-8 p-6 bg-blue-50 dark:bg-gray-700 rounded-lg border border-blue-200 dark:border-gray-600">
                    <div class="flex items-start">
                        ...
                        <div class="ml-4 flex-1">
                            ...
                            <a href="{{ route('school-management.parents.download-template') }}" 
                ...
                <div class="mb-8 p-6 bg-green-50 dark:bg-gray-700 rounded-lg border border-green-200 dark:border-gray-600">
                    <div class="flex items-start">
                        ...
                        <div class="ml-4 flex-1">
                            ...
                            <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">
                                Fill in the template with your parent/guardian data and upload it here.
                            </p>
                            
                            <form action="{{ route('school-management.parents.bulk-upload') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="mb-4">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <ul class="list-disc list-inside text-sm text-gray-600 dark:text-gray-400 space-y-1">
                                <li><strong>first_name</strong> - Parent/Guardian's first name</li>
                                <li><strong>last_name</strong> - Parent/Guardian's last name</li>
                                <li><strong>email</strong> - Valid email address (must be unique)</li>
                                <li><strong>phone</strong> - Phone number</li>
                                <li><strong>relationship</strong> - Must be one of: father, mother, guardian, other</li>
                            </ul>
                        </div>
                        <div>
                            ...
                            <ul class="list-disc list-inside text-sm text-gray-600 dark:text-gray-400 space-y-1">
                                ...
                                <li><strong>emergency_contact</strong> - Emergency contact information</li>
                                <li><strong>status</strong> - Must be: active or inactive (defaults to active if not provided)</li>
                            </ul>
                        </div>
                        <div class="mt-4 p-3 bg-yellow-50 dark:bg-gray-600 rounded border border-yellow-200 dark:border-gray-500">
                            <p class="text-sm text-yellow-800 dark:text-yellow-200">
                                <strong>Note:</strong> The CSV file must have a header row with column names. Each row after the header represents one parent/guardian. Empty rows will be skipped.
                            </p>
                        </div>
                    </div>
                </div>
