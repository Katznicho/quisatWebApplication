    ...
    <div class="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full space-y-8">
            ...
            <div class="flex flex-col space-y-3">
                ...
                <div class="w-full">
                    <form method="POST" action="{{ route('business.resend.verification') }}" class="space-y-3">
                        @csrf
                        <div>
                            <label for="email" class="block text-sm font-medium text-gray-700 mb-1">Enter your email to resend verification:</label>
                            <input type="email" 
                                   id="email" 
                                   name="email" 
                                   required
            ...
            <div class="text-center">
                <p class="text-xs text-gray-500">
                    ...
                    <a href="mailto:no-reply@quisat.com" class="text-indigo-600 hover:text-indigo-500">
                        no-reply@quisat.com
                    </a>
                </p>
            </div>
