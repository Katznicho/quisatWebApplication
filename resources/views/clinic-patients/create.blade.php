...
<div class="container mx-auto px-4 py-8 max-w-3xl">
    <div class="mb-6">
        ...
        <h1 class="text-3xl font-bold text-gray-900 dark:text-white mt-3">Import patient from school</h1>
        <p class="mt-2 text-gray-600 dark:text-gray-400">
            Ask the parent for their child&apos;s <strong>school access code</strong> (from the Quisat parent app).
            Each child has their own code — it imports name, date of birth, photo, and parent details automatically.
        </p>
    </div>
    ...
    <div class="bg-white rounded-lg shadow p-6 mb-6">
        <h2 class="text-lg font-semibold text-gray-900 mb-4">Search by access code</h2>
    ...
    @if(isset($previewStudent) && $previewStudent)
        <div class="bg-white rounded-lg shadow overflow-hidden border-2 border-green-200">
    ...
    <div class="mt-8 p-4 bg-gray-50 rounded-lg border border-gray-200 text-sm text-gray-600">
        ...
        <ul class="list-disc list-inside space-y-1">
            <li>Codes are created in the parent app under <strong>Kids Clinics → your child&apos;s code</strong>.</li>
            <li>Parents can also link themselves from the app; this screen is for walk-in registration.</li>
            <li>Do not create manual records — always use the school access code.</li>
        </ul>
    </div>
</div>
@endsection
