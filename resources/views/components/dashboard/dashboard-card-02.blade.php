<div class="flex flex-col col-span-full sm:col-span-6 xl:col-span-4 bg-white dark:bg-gray-800 shadow-sm rounded-xl">
    <div class="px-5 pt-5">
        <header class="flex justify-between items-start mb-2">
            <h2 class="text-lg font-semibold text-gray-800 dark:text-gray-100">Total Fund Raisers</h2>
            <!-- Menu button -->
        ...
        <div class="text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase mb-1">all recorded fund raisers to date</div>
        <div class="flex items-start">
            {{-- <div class="text-3xl font-bold text-gray-800 dark:text-gray-100 mr-2">${{ number_format($dataFeed->sumDataSet(2, 1), 0) }}</div> --}}
            <div class="text-3xl font-bold text-gray-800 dark:text-gray-100 mr-2">{{ number_format($fundraisers, 0) }}</div>
            <div class="text-sm font-medium text-red-700 px-1.5 bg-red-500/20 rounded-full">0%</div>
        </div>
    </div>
