        ...
        <div class="space-y-8">
            ...
            <div>
                ...
                <ul class="mt-3 space-y-2" x-data="{ openGroup: '' }">
                    ...
                    <!-- Staff -->
                    <li>
                        <button @click="openGroup === 'staff' ? openGroup = '' : openGroup = 'staff'" :class="openGroup === 'staff' ? 'border border-blue-500 text-blue-700 bg-blue-50' :
                                'text-gray-700 hover:text-blue-700'" class="flex items-center justify-between w-full text-left pl-4 pr-3 py-2 rounded-md">
                        ...
                        <ul x-show="openGroup === 'staff'" x-collapse class="mt-1 space-y-1 pl-10">
                            ...
                            <li><a href="{{ route('dashboard') }}" class="block text-sm text-gray-700 hover:text-blue-700 py-1.5">Manage
                                    Contractors</a></li>
                            <li><a href="{{ route('dashboard') }}" class="block text-sm text-gray-700 hover:text-blue-700 py-1.5">Manage Contractor
                                    Services</a></li>
                            <li><a href="{{ route('roles.index') }}" class="block text-sm text-gray-700 hover:text-blue-700 py-1.5">Manage Roles</a></li>
                            <li><a href="{{ route('dashboard') }}" class="block text-sm text-gray-700 hover:text-blue-700 py-1.5">Manage Staff
                                    Groups</a></li>
                        </ul>
                    </li>
                    ...
                    <!-- Businesses -->
                    <li>
                        <button @click="openGroup === 'business' ? openGroup = '' : openGroup = 'business'" :class="openGroup === 'business' ? 'border border-blue-500 text-blue-700 bg-blue-50' :
                                'text-gray-700 hover:text-blue-700'" class="flex items-center justify-between w-full text-left pl-4 pr-3 py-2 rounded-md">
                    ...
                    {{-- <!-- Settings --}}
                    <li>
                        <button @click="openGroup === 'settings' ? openGroup = '' : openGroup = 'settings'" :class="openGroup === 'settings' ? 'border border-blue-500 text-blue-700 bg-blue-50' :
                                'text-gray-700 hover:text-blue-700'" class="flex items-center justify-between w-full text-left pl-4 pr-3 py-2 rounded-md">
                        ...
                        <ul x-show="openGroup === 'settings'" x-collapse class="mt-1 space-y-1 pl-10">
                            <li><a href="{{ route('service-points.index') }}" class="block text-sm text-gray-700 hover:text-blue-700 py-1.5">Manage Service Points</a>
                            </li>
                            <li><a href="{{ route('departments.index') }}" class="block text-sm text-gray-700 hover:text-blue-700 py-1.5">Manage Departments</a>
                            </li>
                            <li><a href="{{ route('qualifications.index') }}" class="block text-sm text-gray-700 hover:text-blue-700 py-1.5">Manage Qualifications</a>
                            </li>
                            <li><a href="{{ route('titles.index') }}" class="block text-sm text-gray-700 hover:text-blue-700 py-1.5">Manage Titles</a>
                            </li>
                            <li><a href="{{ route('rooms.index') }}" class="block text-sm text-gray-700 hover:text-blue-700 py-1.5">Manage Rooms</a>
                            </li>
                        </ul>
                    </li>
                    {{-- Settings --}}
