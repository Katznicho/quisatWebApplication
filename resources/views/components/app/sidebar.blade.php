        ...
        <div class="space-y-8">
            ...
            <div>
                ...
                <ul class="mt-3 space-y-2" x-data="{ openGroup: '' }">
                    ...
                    <!-- Kids Fun Venues -->
                    @if (auth()->user()->business_id != 1 && $business && $business->hasFeatureByName('Kids Fun Venues'))
                    <li>
                    ...
                    <!-- Parent Corner -->
                    @if (auth()->user()->business_id != 1 && $business && $business->hasFeatureByName('Parent Corner'))
                    <li>
                        <a href="{{ route('parent-corners.index') }}"
                            ...
                            <span class="ml-3">Parent Corner</span>
                        </a>
                    </li>
                    @endif
                    ...
                    <!-- Kids Clinics -->
                    @if (auth()->user()->business_id != 1 && $business && $business->hasFeatureByName('Kids Clinics'))
                    <li>
                        <a href="{{ route('clinic-patients.index') }}"
                            ...
                            <span class="ml-3">Kids Clinics</span>
                        </a>
                    </li>
                    @endif

                    <!-- Kids Church -->
                    @if (auth()->user()->business_id != 1 && $business && $business->isChurch())
                    <li>
                        <a href="{{ route('kids-church.index') }}"
                            class="flex items-center pl-4 pr-3 py-2 rounded-md {{ request()->routeIs('kids-church.index') ? 'border border-blue-500 text-blue-700 bg-blue-50' : 'text-gray-700 hover:text-blue-700 hover:bg-blue-50' }}">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor" class="w-5 h-5 shrink-0">
                                <path stroke-linecap="round" stroke-linejoin="round"
                            ...
                            <span class="ml-3">Kids Church</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ $business->usesKidsChurchHub() ? route('kids-church.index', ['tab' => 'prayer']) : route('school-management.prayer-requests') }}"
                            class="flex items-center pl-4 pr-3 py-2 rounded-md {{ (request()->routeIs('kids-church.index') && request('tab') === 'prayer') || request()->routeIs('school-management.prayer-requests') ? 'border border-blue-500 text-blue-700 bg-blue-50' : 'text-gray-700 hover:text-blue-700 hover:bg-blue-50' }}">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor" class="w-5 h-5 shrink-0">
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12z" />
                    ...
                    <li>
                        <a href="{{ $business->usesKidsChurchHub() ? route('kids-church.index', ['tab' => 'feedback']) : route('school-management.church-feedback') }}"
                            class="flex items-center pl-4 pr-3 py-2 rounded-md {{ (request()->routeIs('kids-church.index') && request('tab') === 'feedback') || request()->routeIs('school-management.church-feedback') ? 'border border-blue-500 text-blue-700 bg-blue-50' : 'text-gray-700 hover:text-blue-700 hover:bg-blue-50' }}">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor" class="w-5 h-5 shrink-0">
                                <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    @if (auth()->user()->business_id != 1)
                        @php
                            ...
                            $showSchoolModules = $business && ($business->isSchool() || ! $isChurch);
                        @endphp
                        <!-- Terms -->
                        @if ($showSchoolModules && $business && $business->hasFeatureByName('Term Management'))
                        <li>
                        ...
                        <!-- Classes -->
                        @if ($showSchoolModules && $business && $business->hasFeatureByName('Class Room Management'))
                        <li>
                        ...
                        <!-- Subjects -->
                        @if ($showSchoolModules && $business && $business->hasFeatureByName('Subject Management'))
                        <li>
                        ...
                        <!-- Students -->
                        @if ($showSchoolModules && $business && $business->hasFeatureByName('Student Management'))
                        <li>
                        ...
                        <!-- Attendance Tracking -->
                        @if ($showSchoolModules && $business && $business->hasFeatureByName('Attendance Management'))
                        <li>
                        ...
                        <!-- Calendar & Events -->
                        @if ($showSchoolModules && $business && $business->hasFeatureByName('Calendar & Events Management'))
                        <li>
                        ...
                        <!-- Timetable -->
                        @if ($showSchoolModules && $business && $business->hasFeatureByName('Timetable Management'))
                        <li>
                        ...
                        <!-- Assignments & Grades -->
                        @if ($showSchoolModules && $business && $business->hasFeatureByName('Grade Management'))
                        <li>
                        ...
                        <!-- Exams -->
                        @if ($showSchoolModules && $business && $business->hasFeatureByName('Exam Management'))
                        <li>
                        ...
                        <!-- Parents & Guardians -->
                        @if ($showSchoolModules && $business && $business->hasFeatureByName('Parent Guardian Management'))
                        <li>
                        ...
                        <!-- Financials -->
                        @if ($business && ($business->hasFeatureByName('Fee Management') || $business->hasFeatureByName('Kids Clinics') || $isChurch))
                        @php
                            $clinicFinancials = $business->hasFeatureByName('Kids Clinics')
                                && ! $business->hasFeatureByName('Student Management');
                            if ($clinicFinancials) {
                                $financialsUrl = route('clinic-patients.index', ['tab' => 'fees']);
                            } elseif ($business->usesKidsChurchHub()) {
                                $financialsUrl = route('kids-church.index', ['tab' => 'fees']);
                            } else {
                                $financialsUrl = route('school-management.fees');
                            }
                        @endphp
                        <li>
                    ...
                    <!-- Marketplace (Kids Mart / Stationery Hub) -->
                    @php
                        $hasKidsMart = $business && $business->hasFeatureByName('KidsMart');
                        $hasStationery = $business && $business->hasFeatureByName('StationeryHub');
                    @endphp
                    @if (auth()->user()->business_id != 1 && ($hasKidsMart || $hasStationery))
                        <li>
                            <button @click="openGroup === 'marketplace' ? openGroup = '' : openGroup = 'marketplace'"
                                :class="openGroup === 'marketplace' ? 'border border-blue-500 text-blue-700 bg-blue-50' :
                                    'text-gray-700 hover:text-blue-700'"
                                class="flex items-center justify-between w-full text-left pl-4 pr-3 py-2 rounded-md">
                                <div class="flex items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                ...
                                <svg class="w-4 h-4 transform transition-transform duration-200"
                                    :class="{ 'rotate-180': openGroup === 'marketplace' }" fill="none"
                                    stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                    <path d="M19 9l-7 7-7-7" />
                                </svg>
                            </button>
                            <ul x-show="openGroup === 'marketplace'" x-collapse class="mt-1 space-y-1 pl-10">
