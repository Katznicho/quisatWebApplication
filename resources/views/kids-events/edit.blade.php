                        ...
                        <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="text" id="organizer_name" name="organizer_name" value="{{ old('organizer_name', $kidsEvent->organizer_name) }}" 
                                ...
                                <div>
                                    ...
                                    <input type="email" id="organizer_email" name="organizer_email" value="{{ old('organizer_email', $kidsEvent->organizer_email) }}" 
                                ...
                                <div>
                                    ...
                                    <input type="tel" id="organizer_phone" name="organizer_phone" value="{{ old('organizer_phone', $kidsEvent->organizer_phone) }}" 
                                           placeholder="+1 (555) 123-4567"
                                ...
                                <div>
                                    ...
                                    <input type="text" id="organizer_address" name="organizer_address" value="{{ old('organizer_address', $kidsEvent->organizer_address) }}" 
