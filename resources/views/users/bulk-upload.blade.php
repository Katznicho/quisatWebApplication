                ...
                <div class="mb-8 p-6 bg-green-50 dark:bg-gray-700 rounded-lg border border-green-200 dark:border-gray-600">
                    <div class="flex items-start">
                        ...
                        <div class="ml-4 flex-1">
                            ...
                            <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">
                                Fill in the template with your user data and upload it here.
                            </p>
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <ul class="list-disc list-inside text-sm text-gray-600 dark:text-gray-400 space-y-1">
                                ...
                                <li><strong>status</strong> - Must be one of: active, inactive, suspended</li>
                                <li><strong>role_name</strong> - Role name (must exist in the system for your business)</li>
                            </ul>
                        </div>
                        <div>
                            ...
                            <ul class="list-disc list-inside text-sm text-gray-600 dark:text-gray-400 space-y-1">
                                ...
                                <li><strong>branch_name</strong> - Branch name (must exist in the system for your business)</li>
                            </ul>
                        </div>
                        <div class="mt-4 p-3 bg-yellow-50 dark:bg-gray-600 rounded border border-yellow-200 dark:border-gray-500">
                            <p class="text-sm text-yellow-800 dark:text-yellow-200">
                                <strong>Note:</strong> The CSV file must have a header row with column names. Each row after the header represents one user. Empty rows will be skipped. Roles and branches must be created in the system before bulk uploading users. A password reset link will be sent to each user's email address.
                            </p>
                        </div>
                    </div>
                </div>
