                ...
                <form action="{{ route('programs.update', $program) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="space-y-8">
                        ...
                        <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-6">
                            ...
                            @php
                                $programSocials = $program->social_media_handles ?? [];
                                if (is_string($programSocials)) {
                                    $decoded = json_decode($programSocials, true);
                                    $programSocials = is_array($decoded) ? $decoded : [];
                                }
                                $programSocials = is_array($programSocials) ? $programSocials : [];
                            @endphp

                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Website</label>
                                    <input type="text" name="social_media_handles[website]"
                                           value="{{ old('social_media_handles.website', $programSocials['website'] ?? '') }}"
                                ...
                                <div>
                                    ...
                                    <input type="text" name="social_media_handles[facebook]"
                                           value="{{ old('social_media_handles.facebook', $programSocials['facebook'] ?? '') }}"
                                           placeholder="https://facebook.com/yourpage"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-800 dark:text-white">
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Instagram</label>
                                    <input type="text" name="social_media_handles[instagram]"
                                           value="{{ old('social_media_handles.instagram', $programSocials['instagram'] ?? '') }}"
                                           placeholder="https://instagram.com/yourprofile"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-800 dark:text-white">
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">X / Twitter</label>
                                    <input type="text" name="social_media_handles[twitter]"
                                           value="{{ old('social_media_handles.twitter', $programSocials['twitter'] ?? '') }}"
                                           placeholder="https://x.com/yourprofile"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-800 dark:text-white">
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">WhatsApp</label>
                                    <input type="text" name="social_media_handles[whatsapp]"
                                           value="{{ old('social_media_handles.whatsapp', $programSocials['whatsapp'] ?? '') }}"
