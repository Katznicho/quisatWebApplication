...
<body class="bg-gray-100">
    <div class="container mx-auto p-8">
        <h1 class="text-2xl font-bold mb-6">Chat Functionality Test</h1>
        
        <!-- Test Contacts -->
        <div class="bg-white rounded-lg shadow p-6 mb-6">
            <h2 class="text-lg font-semibold mb-4">Test Contacts</h2>
            <div class="space-y-2">
    ...
    <script>
        ...
        document.querySelectorAll('.contact-item').forEach(contact => {
            contact.addEventListener('click', function() {
                ...
                // Update debug info
                document.getElementById('buttonStatus').textContent = 'Enabled';
                document.getElementById('buttonStatus').className = 'text-green-600';
