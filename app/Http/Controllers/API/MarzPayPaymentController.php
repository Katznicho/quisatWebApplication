...
class MarzPayPaymentController extends Controller
{
    public function collect(
        ...
        $validated = $request->validate([
            'payable_type' => 'required|in:order,kids_event_registration,parent_corner_registration,program_registration,clinic_appointment,calendar_event_registration,school_fee,fee',
